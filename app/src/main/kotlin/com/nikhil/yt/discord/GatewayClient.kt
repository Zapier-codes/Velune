...
class GatewayClient {
    ...
    private fun sendIdentify() {
        ...
        val appName = com.nikhil.yt.App.instance.getString(com.nikhil.yt.R.string.app_name)
        properties.put("os", "Android")
        properties.put("browser", appName)
        properties.put("device", "Android")
        properties.put("browser_user_agent", appName)
