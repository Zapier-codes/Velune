...
package com.nikhil.yt.listentogether
...
import com.nikhil.yt.constants.ListenTogetherAutoApprovalKey
import com.nikhil.yt.constants.ListenTogetherIsHostKey
import com.nikhil.yt.constants.ListenTogetherRoomCodeKey
import com.nikhil.yt.constants.ListenTogetherServerUrlKey
import com.nikhil.yt.constants.ListenTogetherSessionTimestampKey
import com.nikhil.yt.constants.ListenTogetherSessionTokenKey
import com.nikhil.yt.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "com.nikhil.yt.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "com.nikhil.yt.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "com.nikhil.yt.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "com.nikhil.yt.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private fun loadBlockedUsernames() {
        try {
            val blockedJson = context.dataStore.get(com.nikhil.yt.constants.ListenTogetherBlockedUsersKey, "")
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[com.nikhil.yt.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {
