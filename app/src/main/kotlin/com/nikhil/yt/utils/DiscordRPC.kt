...
class DiscordRPC(
    ...
    companion object {
        ...
        private const val PAUSE_IMAGE_URL =
            "https://raw.githubusercontent.com/Zapier-codes/Velune/main/fastlane/metadata/android/en-US/images/RPC/pause_icon.png"
        private const val APP_ICON_URL = 
            "https://raw.githubusercontent.com/Zapier-codes/Velune/main/fastlane/metadata/android/en-US/images/icon.png"
    ...
    suspend fun updateSong(
        ...
        val button2Label = context.dataStore[DiscordActivityButton2LabelKey] ?: ("Go to " + context.getString(R.string.app_name))
        ...
        val button2CustomUrl = context.dataStore[DiscordActivityButton2CustomUrlKey] ?: "https://github.com/Zapier-codes/Velune"
