/*
 * Velune - Audio Export Service.
 * Ported from Echo Music (GPL-3.0).
 * Downloads highest-quality stream and transcodes to MP3 via FFmpeg.
 */
...
class AudioExportService : Service() {
    ...
    private fun downloadStream(
        playbackData: com.nikhil.yt.utils.YTPlayerUtils.PlaybackData,
        destFile: File,
    ) {
